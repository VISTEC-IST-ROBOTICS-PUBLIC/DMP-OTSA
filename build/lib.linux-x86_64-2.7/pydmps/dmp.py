...
class DMPs(object):
    ...
    def reset_state(self, y0 = None):
        ...
        self.dy_raw = np.zeros(self.n_dmps)
    ...
    def step(self, tau=1.0, error=0.0, external_force=None):
        ...
        for d in range(self.n_dmps):
            ...
            self.dy_raw[d] = self.dy[d] / tau
            self.y[d] += self.dy_raw[d] * self.dt 

        return self.y, self.dy_raw, self.ddy
